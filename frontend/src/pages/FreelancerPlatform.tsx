...
const FREELANCERS: Freelancer[] = [
  { id: 1, name: "Ashan Kumara",      title: "Full Stack Developer", rating: 5, reviews: 142, rate: 45, skills: ["React", "Node.js", "MongoDB"], avatarBg: "#14a800" },
  { id: 2, name: "Saman Perera",      title: "UI/UX Designer",       rating: 5, reviews: 98,  rate: 55, skills: ["Figma", "Prototyping"],        avatarBg: "#7c3aed" },
  { id: 3, name: "Nadeesha Fernando", title: "Mobile Developer",     rating: 4, reviews: 67,  rate: 40, skills: ["Flutter", "Firebase"],         avatarBg: "#dc2626" },
  { id: 4, name: "Ruwani Jayaweera",  title: "Content Writer",       rating: 5, reviews: 203, rate: 30, skills: ["SEO", "Copywriting"],          avatarBg: "#d97706" },
];
...
const FOOTER_LINKS = [
  { heading: "For clients",     links: ["How to hire", "Talent marketplace", "Post a job", "Enterprise"] },
  { heading: "For freelancers", links: ["How to find work", "Profile best practices", "Connects", "Resources"] },
  { heading: "Resources",       links: ["Help center", "Blog", "Community", "Affiliate program"] },
  { heading: "Company",         links: ["About us", "Careers", "Press", "Contact us"] },
];

const NAV_LINKS   = ["Find talent", "Find work", "Why us", "Enterprise"];
        ...
        <div className="flex items-center justify-between px-4 sm:px-6 lg:px-10 py-3">
          ...
          <div className="hidden md:flex items-center gap-2 shrink-0">
            ...
            <button
              ...
              onClick={() => navigate("/signup?intent=post-job")}
            >
              Post a job
            </button>
          </div>
          ...
          <div className="md:hidden border-t border-gray-100 bg-white px-4 pb-4 pt-2 flex flex-col gap-1">
            ...
            <div className="flex gap-2 mt-3 pt-3 border-t border-gray-100">
              ...
              <button
                ...
                onClick={() => { setMobileMenuOpen(false); navigate("/signup?intent=post-job"); }}
              >
                Post a job
              </button>
            </div>
        ...
        <div className="max-w-4xl mx-auto relative">
          ...
          <div className="flex gap-2 flex-wrap items-center mt-4">
            ...
            {POPULAR_TAGS.map((tag) => (
              <button
                key={tag}
                className="px-3 py-1 border border-white/25 rounded-full text-xs text-gray-200 bg-white/10 hover:border-green-500 hover:text-green-400 transition-all"
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex gap-4 overflow-x-auto pb-2 snap-x snap-mandatory sm:grid sm:grid-cols-2 sm:overflow-visible sm:pb-0 lg:grid-cols-4">
            {FREELANCERS.map((fl) => (
              <button
                key={fl.id}
                className="snap-start shrink-0 w-[72vw] xs:w-64 sm:w-auto bg-white border border-gray-200 rounded-xl p-4 sm:p-5 text-left hover:border-green-600 hover:shadow-md hover:-translate-y-0.5 transition-all active:scale-95"
                onClick={() => navigate(`/freelancers/${fl.id}`)}
              >
                <div
                ...
                <div className="text-amber-500 text-xs mb-1.5" aria-label={`${fl.rating} out of 5 stars`}>
      ...
      <div className="bg-[#001e00] py-10 sm:py-14 px-4 sm:px-6 lg:px-10">
        <div className="max-w-4xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-6 sm:gap-8">
          ...
          <div className="flex gap-3 shrink-0">
            <button
              className="px-5 sm:px-7 py-2.5 sm:py-3 bg-white text-gray-900 rounded-full text-sm sm:text-base font-semibold hover:opacity-85 transition-opacity"
              onClick={() => navigate("/signup?intent=post-job")}
            >
              Post a job
            </button>
            <button
              className="px-5 sm:px-7 py-2.5 sm:py-3 bg-transparent text-white border border-white/40 rounded-full text-sm sm:text-base font-semibold hover:border-white transition-colors"
              ...
              <div key={heading}>
                ...
                {links.map((link) => (
                  <a
                    key={link}
                    href="#"
                    className="block text-xs sm:text-sm text-gray-500 mb-2 hover:text-green-600 transition-colors"
                  >
                    {link}
                  </a>
                ))}
